...
#define LEDSAVAIL 8
static const uint8_t ledBits[LEDSAVAIL] = {7, 13, 16, 17, 19, 27, 28, 18};

#define KEYSAVAIL 3
static const uint8_t keyBits[KEYSAVAIL] = {12, 4, 1};
static const uint8_t keyIoConNdce[KEYSAVAIL] = {IOCON_PIO12, IOCON_PIO4, IOCON_PIO1};
